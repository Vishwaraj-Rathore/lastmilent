...
const AboutSection = () => {
  return (
    <div
      className={`w-full min-h-[calc(100vh-80px)] bg-white flex flex-col items-center justify-center px-4 pb-16 md:pb-0 ${cormorantGaramond.className}`}
    >
      <div className="text-center max-w-3xl mb-12 md:mb-20">
        <h1 className="text-3xl md:text-4xl text-[#1a2844] px-2">
          {
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
        <div className="bg-[#1a2844] p-6 md:p-8 text-white">
          <h2 className="text-2xl mb-4 md:mb-6">About us</h2>
        ...
        <div className="bg-[#1a2844] p-6 md:p-8 text-white">
          <p className="text-sm mb-3 md:mb-4">ADDRESS</p>
          ...
          <p className="text-lg md:text-xl mb-6">079- 26402089</p>

          <p className="text-sm mb-2">E-MAIL</p>
          <p className="text-lg md:text-xl">info@lastmilent.com</p>
        </div>
      </div>
    </div>
  );
