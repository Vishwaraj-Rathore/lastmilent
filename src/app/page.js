      ...
      <section className="w-full h-[calc(100vh-80px)] flex flex-col lg:flex-row">
        <div className="w-full lg:w-1/2 h-1/2 lg:h-full flex flex-col justify-center items-center p-8 lg:p-16 bg-white order-1 lg:order-2">
          <div className="max-w-xl text-center lg:text-left">
            ...
            `}>
              Last Mile Enterprises is a dynamic company committed to delivering innovative solutions 
              that bridge gaps and create meaningful impact. We specialize in transformative strategies 
            ...
            `}>
              Our team combines expertise, creativity, and passion to drive sustainable growth 
              and provide cutting-edge solutions across various industries.
            </p>
          </div>
        </div>
